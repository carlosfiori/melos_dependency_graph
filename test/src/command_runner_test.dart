...
import 'package:melos_dependency_graph/src/command_runner.dart';
...
void main() {
  group('MelosDependencyGraphCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late MelosDependencyGraphCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = MelosDependencyGraphCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = MelosDependencyGraphCommandRunner();
